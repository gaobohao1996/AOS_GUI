...
public class set_data_address_window extends JFrame implements ActionListener
{
	String setting_name;
	...
	int now_width = 0;
	int total_lines = 0;
	public set_data_address_window(String name,gui_learn f)
	{
		setting_name = name;
		father = f;
	...
	public void init()
	{
		this.setTitle(setting_name + " Setting Sensor Layer");
		...
		content.setBackground(new Color(166,224,202));
		...
		intro_sensor = new JLabel("This is the step to setting the Sensor Layers of " + setting_name);
		...
		info = father.all_info.get("sensor");
	...
	public void add_a_line(int num, int h, int w)
	{
		...
		JLabel heightlabel = new JLabel("Height " + String.valueOf(num));
		heightlabel.setFont(new Font("Dialog",0,word));
		JLabel widthlabel = new JLabel("Width " + String.valueOf(num));
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (e.getSource() == finish)
		{
			...
			father.all_info.put("sensor", sensor_list);
